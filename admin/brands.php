  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_brand_modal" class="btn btn-primary btn-sm">เพิ่มแบรนด์</a>
      	</div>
      </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">เพิ่มแบรนด์</h5>
      ...
      <div class="modal-body">
        <form id="add-brand-form" enctype="multipart/form-data">
        	<div class="row">
        		...
        		<div class="col-12">
        			<button type="button" class="btn btn-primary add-brand">เพิ่มผลิตภัณฑ์</button>
        		</div>
        	</div>
      ...
      <div class="modal-body">
        <form id="edit-brand-form" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-12">
              <button type="button" class="btn btn-primary edit-brand-btn">อัปเดตแบรนด์</button>
            </div>
          </div>
