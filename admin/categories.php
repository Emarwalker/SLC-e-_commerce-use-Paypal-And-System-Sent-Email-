  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_category_modal" class="btn btn-primary btn-sm">เพิ่มหมวดหมู่</a>
      	</div>
      </div>
      ...
      <div class="modal-body">
        <form id="add-category-form" enctype="multipart/form-data">
        	<div class="row">
        		...
        		<div class="col-12">
        			<button type="button" class="btn btn-primary add-category">เพิ่มหมวดหมู่</button>
        		</div>
        	</div>
      ...
      <div class="modal-body">
        <form id="edit-category-form" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-12">
              <button type="button" class="btn btn-primary edit-category-btn">อัปเดตหมวดหมู่</button>
            </div>
          </div>
