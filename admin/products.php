  ...
  <div class="row">
    ...
    <?php include "./templates/sidebar.php"; ?>
      ...
      <div class="row">
      	...
      	<div class="col-2">
      		<a href="#" data-toggle="modal" data-target="#add_product_modal" class="btn btn-primary btn-sm">เพิ่มผลิตภัณฑ์</a>
      	</div>
      </div>
              ...
              <div class="form-group">
        		...
        		<div class="col-12 ">
        			<div class="form-group ">
		        		...
		        		<input type="text" value="เสื้อ" name="product_keywords" class="form-control" placeholder="Enter Product Keywords">
		        	</div>
        		</div>
        		<div class="col-12">
        			<div class="form-group">
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="form-group">
                ...
                <input type="text" value="เสื้อ" name="e_product_keywords" class="form-control" placeholder="Enter Product Keywords">
              </div>
            </div>
            <div class="col-12">
              <div class="form-group">
